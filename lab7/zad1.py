...
def first_plot():
	psi_minus_one = read_data_file("psi_-1000.txt")
	u_minus_one = read_data_file("u_-1000.txt")
	v_minus_one = read_data_file("v_-1000.txt")
	zeta_minus_one = read_data_file("zeta_-1000.txt")
	...
	figure1.colorbar(ax3.imshow(u_minus_one, cmap='jet', vmin=-2, vmax=16), ax=ax3)
	figure1.colorbar(ax4.imshow(v_minus_one, cmap='jet', vmin=-6, vmax=1), ax=ax4)
	plt.savefig("Q_-1000.png",bbox_inches='tight',transparent=False)

def second_plot():
	psi_minus_four = read_data_file("psi_-4000.txt")
	u_minus_four = read_data_file("u_-4000.txt")
	v_minus_four = read_data_file("v_-4000.txt")
	zeta_minus_four = read_data_file("zeta_-4000.txt")
	figure1, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, figsize=(20, 10))
	...
	figure1.colorbar(contour_plot1, ax=ax1)
	figure1.colorbar(contour_plot2, ax=ax2)
	figure1.colorbar(ax3.imshow(u_minus_four, cmap='jet', vmin=-10, vmax=70), ax=ax3)
	figure1.colorbar(ax4.imshow(v_minus_four, cmap='jet', vmin=-14, vmax=4), ax=ax4)
	plt.savefig("Q_-4000.png",bbox_inches='tight',transparent=False)

def third_plot():
	psi_four = read_data_file("psi_4000.txt")
	u_four = read_data_file("u_4000.txt")
	v_four = read_data_file("v_4000.txt")
	zeta_four = read_data_file("zeta_4000.txt")
	...
	ax1.set_ylabel('y')
	ax1.set_aspect('equal', adjustable='box')
	figure1.colorbar(contour_plot, ax=ax1)
	plt.savefig("Q_4000.png",bbox_inches='tight',transparent=False)
